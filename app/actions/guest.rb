...
class Guest
  ...
  def new_guest_user
    ...
    @account = User.create!({"email"=>Faker::Internet.email, "username"=>Faker::StarWars.character.gsub(" ", "_"),
  ...
  def guest_todos
    10.times do
      ...
      Todo.create!({title: Faker::StarWars.planet, description: Faker::StarWars.quote,
